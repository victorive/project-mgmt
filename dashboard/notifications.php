	      ...
	      <div id="content" class="p-4 p-md-5 pt-5">
	        ...
	        <div id="storeItems" >
	        	<div class="d-flex justify-content-between">
	        		<h4 style="display: inline-flex; border-bottom: 2px solid #FF3040; color:#040E40"><em>Notifications ...</em></h4>
	        	...
	        	<div>
	        		...
	        		<div class="p-3 azorders">
	        			<div><div style="display: inline-flex; background-color: #4A69FD; color: white; padding: 7px 15px; border-radius: 5px 5px 0 0"> TASK REQUESTS </div></div>
	        			<table class="table" style="width: 100%; background-color: #F8F9FA; box-shadow: 5px 5px 5px #ddd; border:1px solid #ddd">
						    ...
						    <tbody>
						    	<?php 
								    ...
								    WHERE register.id = '$UserId' AND stageonetasks.assignTo = register.email AND stageonetasks.projectname = projects.projectID AND requeststatus = 'requested' AND progressstatus = 'ongoing' ORDER BY taskId desc";
								...
								?>
									<tr>
							            ...
							            <td><i>You have been requested to join this project </i></td>
							            
						            	<td><i><?=$deadline;?> </i></td>
						            	<td>
				                            <div class="row">
				                              <a href="reqaction.php?accept=<?= $taskId; ?>" class="btn btn-success m-1">Accept</a>
				                              <a href="reqaction.php?decline=<?= $taskId; ?>" class="btn btn-danger m-1"> Decline </a>
				                            </div>
				                        </td>
							        </tr>
								<?php }?>
