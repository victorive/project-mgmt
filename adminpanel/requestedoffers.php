	      ...
	      <div id="content" class="p-4 p-md-5 pt-5">
	        ...
	        <div id="storeItems" >
	        	<div class="d-flex justify-content-between">
	        		<h4 style="display: inline-flex; border-bottom: 2px solid #FF3040; color:#040E40"><em>Requested Offers ...</em></h4>
	        			...
	        			<table class="table" style="width: 100%; background-color: #F8F9FA; box-shadow: 5px 5px 5px #ddd; border:1px solid #ddd">
						    ...
						    <tbody>
						    	<?php 
								    ...
								    WHERE stageonetasks.assignTo = register.email AND stageonetasks.projectname = projects.projectID AND requeststatus = 'requested' AND progressStatus = 'ongoing' ORDER BY taskId desc";
									...
									while ($DataRows = $stmtloan->fetch()) {
								    	...
								    	$progresstatus = $DataRows['progressStatus'];
								...
								?>
									<tr>
							            ...
							            <td class="text-danger"><?= $progresstatus;?></td>
						            	<td><i><?=$deadline;?> </i></td>
