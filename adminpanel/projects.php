	      ...
	      <div id="content" class="p-4 p-md-5 pt-5">
	        ...
	        <div id="storeItems" >
	        	<div class="d-flex justify-content-between">
	        		<h4 style="display: inline-flex; border-bottom: 2px solid #FF3040; color:#040E40"><em>Projects</em></h4>
	        		...
	        		<div class="p-2 azorders">
	        			...
	        			<table class="table" style="width: 100%; background-color: #F8F9FA; box-shadow: 5px 5px 5px #ddd; border:1px solid #ddd">
						    ...
						    <tbody>
						    	<?php 
								    global $ConnectingDB;
								    $sql = "SELECT * FROM projects, register
								    WHERE projects.createdby = register.id
								    ORDER BY id desc";
								...
								?>
									<tr>
							            ...
							            <td><?= $projectname; ?></td>
							            <td> created by</td>
							            <td style="color: grey"><i><?= $fullname; ?></i></td>
