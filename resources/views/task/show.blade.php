            ...
            <div class="flex w-full flex-col">
                <div class="mt-4 grid items-center gap-3 gap-y-5 sm:grid-cols-4">
                    ...
                    <div class="flex flex-col sm:col-span-4">
                        ...
                        <input type="text" class="rounded-lg border px-2 py-2 shadow-sm outline-none focus:ring" name="resource" id="" disabled value="{{ $task->description }}"/>
                    </div>
                    ...
                    <div class="flex flex-col sm:col-span-4">
                        ...
                        <input type="text" class="rounded-lg border px-2 py-2 shadow-sm outline-none focus:ring" name="resource" id="" disabled value="{{ $task->status }}"/>
                    </div>
                </div>
            </div>
        </div>
