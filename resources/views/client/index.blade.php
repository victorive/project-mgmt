    ...
    <table class="min-w-full border-collapse border-spacing-y-2 border-spacing-x-2">
      <thead class="hidden border-b lg:table-header-group">
        <tr class="">
          ...
          <td class="whitespace-normal py-4 text-sm font-medium text-gray-800 sm:px-3">Address</td>
      ...
      <tbody class="bg-white lg:border-gray-300">
        ...
        <tr class="">
          ...
          <td class="whitespace-no-wrap hidden py-4 text-sm font-normal text-gray-600 sm:px-3 lg:table-cell">{{ $client->address }}</td>
